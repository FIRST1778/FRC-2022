...
object Loader : FalconSubsystem() {
    private val mainMotor = falconMAX(Constants.Loader.MAIN_WHEEL, CANSparkMaxLowLevel.MotorType.kBrushless, DefaultNativeUnitModel) {
        brakeMode = true
    ...
    fun runMain(percent: Double) = mainMotor.setDutyCycle(percent)
